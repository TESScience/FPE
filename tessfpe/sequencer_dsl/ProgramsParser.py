...
__version__ = (2015, 12, 8, 21, 4, 32, 1)

__all__ = [
    'Programs_standalone_grammerParser',
    'Programs_standalone_grammerSemantics',
    'main'
]


class Programs_standalone_grammerParser(Parser):
    def __init__(self,
                 whitespace=None,
                 nameguard=None,
                 comments_re='\\/\\*.*?\\*\\/',
                 ...
                 left_recursion=True,
                 **kwargs):
        super(Programs_standalone_grammerParser, self).__init__(
...
class Programs_standalone_grammerSemantics(object):
    def symbol(self, ast):
        return ast
...
def main(filename, startrule, trace=False, whitespace=None, nameguard=None):
    ...
    with open(filename) as f:
        text = f.read()
    parser = Programs_standalone_grammerParser(parseinfo=False)
    ast = parser.parse(
        text,
        startrule,
        filename=filename,
...
if __name__ == '__main__':
    ...
    class ListRules(argparse.Action):
        def __call__(self, parser, namespace, values, option_string):
            print('Rules:')
            for r in Programs_standalone_grammerParser.rule_list():
                print(r)
            print()
            sys.exit(0)

    parser = argparse.ArgumentParser(description="Simple parser for Programs_standalone_grammer.")
