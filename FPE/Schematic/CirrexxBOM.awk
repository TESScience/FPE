...
# 	
# device	value	spec	footprint	manufacturer	part#
#
...

{
	...
	thismfr = mfr[key]
	if( !thismfr ) thismfr = "**MISSING**"
	thispart = part[key]
	if( !thispart ) thispart = "**MISSING**"
			
	print ++item TAB qty TAB refdes TAB device, value, spec, footprint TAB thismfr TAB thispart TAB
}
